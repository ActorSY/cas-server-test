 ...
 * @since 4.0
 */
public class LdapAuthenticationHandlerforyixin extends AbstractUsernamePasswordAuthenticationHandler {
    ...
    /** Component name. */
    @NotNull
    private String name = LdapAuthenticationHandlerforyixin.class.getSimpleName();
     ...
     */
    public LdapAuthenticationHandlerforyixin(@NotNull final Authenticator authenticator) {
